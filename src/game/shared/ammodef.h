...
public:
	...
	void				AddAmmoType(char const* name, int damageType, int tracerType, int plr_dmg, char const* npc_var, int carry, float physicsForceImpulse, int nFlags, int minSplashSize = 4, int maxSplashSize = 8 );
